...
/// the point of `docs/memory/fixtures-are-the-weak-point.md#real-data-hides-bugs-small-inputs-expose`: a real 40 KB voice line
...
public sealed class SoundSampleReaderTests
{
    ...
    /// `docs/memory/fixtures-are-the-weak-point.md#put-the-real-file-in-the-fixture`.
    /// </remarks>
