...
/// </summary>
/// <remarks>
/// **B389, and the fault it fixes is one an index-keyed lookup cannot report.** The engine recycles
...
/// client-side-animated player when the index at that tick held a door (B389).
///
