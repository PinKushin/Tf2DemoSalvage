...
public sealed class MapWorldTests
{
    ...
    {
        MapWorld world = MapWorldBuilder.Build([], LightmapAtlas.Pack([]), Camera, null);
    ...
    public void Build_AQuad_BecomesTwoTriangles()
    {
        MapWorld world = MapWorldBuilder.Build(
            [Surface(0, material: 3, corners: 4)], LightmapAtlas.Pack([]), Camera, null);
    ...
    public void Build_DownwardFacingSurfaces_AreDropped()
    {
        ...
        MapWorld world = MapWorldBuilder.Build(
            [Surface(0, material: 0, corners: 3, normalZ: -1f)],
            LightmapAtlas.Pack([]),
            Camera,
            null);
    ...
    public void Build_ToolSurfaces_AreDropped()
    {
        ...
        MapWorld world = MapWorldBuilder.Build(
            [Surface(0, material: 0, corners: 3, flags: SurfaceProperties.NoDraw)],
            LightmapAtlas.Pack([]),
            Camera,
            null);
    ...
    public void Build_EachBatchCoversOnlyItsOwnMaterialsVertices()
    {
        ...
        MapWorld world = MapWorldBuilder.Build(surfaces, LightmapAtlas.Pack([]), Camera, null);
    ...
    public void Build_LightmapCoordinatesLandInsideTheFacesAtlasRectangle()
    {
        ...
        MapWorld world = MapWorldBuilder.Build(
            [Surface(1, material: 0, corners: 3)], atlas, Camera, null);
    ...
    public void Build_TextureCoordinatesArePassedThroughUnchanged()
    {
        ...
        MapWorld world = MapWorldBuilder.Build(
            [Surface(0, material: 0, corners: 3, u: 12.5f)], LightmapAtlas.Pack([]), Camera, null);
