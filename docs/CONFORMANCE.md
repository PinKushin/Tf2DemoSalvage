...
| `DetailModelConformanceTests` | detail props that are MODELS: the type separates two populations indexing two dictionaries, the alpha is the sprites' own fade, zero alpha is not drawn, `ComputeAngles` applies to models too, and `cl_detail_multiplier` does not | `detailobjectsystem.cpp:694, 1829, 2742`, `clientleafsystem.cpp:1718` |
