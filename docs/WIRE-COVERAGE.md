...
**98 of 1122** declared table/property pairs are mentioned at all, across 173 tables.
...
```
m_flEncodedController, m_flFadeScale, m_flModelWidthScale, m_hLightingOrigin, m_hLightingOriginRelative, m_nForceBone, m_nHitboxSet, m_vecForce
```
