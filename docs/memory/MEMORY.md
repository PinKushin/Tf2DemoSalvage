...
- [Name the trade before fixing Valve](name-the-trade-before-fixing-valve.md) — the fast inverse square root looks like a bug; name the trade before changing it, and check whether it was against DX9 or a console.
