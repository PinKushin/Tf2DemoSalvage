...
- [A client dates a protocol, a demo does not](a-client-dates-a-protocol-a-demo-does-not.md) — three separate questions: do we hold a specimen, when was the protocol current, when was this demo recorded.
