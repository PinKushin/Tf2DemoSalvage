...
- [NUnit shared fixture is the standard](nunit-shared-fixture-is-the-standard.md) — never InstancePerTestCase by default; a UI fixture shares one launched app on purpose.
