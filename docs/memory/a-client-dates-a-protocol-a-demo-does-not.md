---
name: a-client-dates-a-protocol-a-demo-does-not
description: A demo's protocol bounds its recording date not at all — old clients still run. Protocol windows come from changelogs and forum posts, not from demos.
metadata:
  type: project
---
...
**The protocol windows are estimates and always were.** They come from following changelogs and
