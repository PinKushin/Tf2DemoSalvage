...
than three samples" for a door because its chosen track was long dead at the tick asked for. B386:
...
tick-aware overload exists since B386 and selects with `ScenePropTrack.Alive`, the same bound `At` and
