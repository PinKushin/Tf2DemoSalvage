...
/// </summary>
/// <remarks>
/// **Extracted for the same reason as <see cref="BlendStates"/> and <see cref="DecalState"/>: a
...
/// </remarks>
internal static class PlayerSkin
{
    ...
    /// </remarks>
    internal static int ForTeam(int? team) => team == SceneTeams.Blu ? 1 : 0;
}
